...
int main(void)
{
    ...
    #ifdef TEST
        startTesting(1); //anda new
        startTesting(2); //anda add
        startTesting(3); //anda delete
        startTesting(4); //anda len
        startTesting(5); //anda get
        startTesting(6); //anda contains
        startTesting(7); //anda set
        startTesting(8); //anda remove
        startTesting(9); //anda clear
        startTesting(10); //anda clone
        startTesting(11); //anda push
        startTesting(12); //anda indexof
        startTesting(13); // anda isempty
        startTesting(14); // anda pop
        startTesting(15); // sublist falta 60% (no obligatorio)
        startTesting(16); // containsall falta 75% (no obligatorio)
        startTesting(17); // sort 60% (no obligatorio)
    #else
        //run();
        run2();
    #endif
